...
class ShariffBlockPlugin extends BlockPlugin {
	...
	function getContents(&$templateMgr, $request) {
		...
		// services
		$selectedServices = $plugin->getSetting($pressId, 'selectedServices');
		...
		// theme
		$selectedTheme = $plugin->getSetting($pressId, 'selectedTheme');
		// backend URL
		$backendUrl = $plugin->getSetting($pressId, 'backendUrl');
